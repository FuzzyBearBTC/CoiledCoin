...
static const int64 MIN_RELAY_TX_FEE = CENT/2;
static const int64 MAX_MONEY = 1000000000 * COIN; /* somewhat arbitrary */
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("02d4283df30021f3e04a94bf82b89d35c5625aebacaf9ec4120cb0703956c7d696")))
